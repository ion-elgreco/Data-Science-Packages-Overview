...
Overview packages/applications/tools

<h2>Python</h2>

**Package** | **Type** | **Docs** 
--- |  --- | --- 
[NumPy](https://github.com/numpy/numpy)|  _array_ | https://numpy.org/doc/stable/ 
[SciPy](https://github.com/scipy/scipy)| _sparse arrays_ | https://docs.scipy.org/doc/scipy/reference/ 
...
[TensorFlow Addons](https://github.com/tensorflow/addons/) | _Deep Learning Framework Addons, usually experimental, newly researched topics that are promising_ | https://www.tensorflow.org/api_docs 
...
[ffmpeg](https://github.com/kkroening/ffmpeg-python)| (ffmpeg-python) _video processing toolkit_ | https://kkroening.github.io/ffmpeg-python/ 
[OpenCV](https://github.com/opencv/opencv)| _Computer vision toolkit_ | https://docs.opencv.org/ 
[NLTK](https://github.com/nltk/nltk)| _NLP toolkit_ | https://www.nltk.org/index.html 
[Matplotlib](https://github.com/matplotlib/matplotlib/)|  _plotting_ | https://matplotlib.org/stable/contents.html 
[Seaborn](https://github.com/mwaskom/seaborn)| _plotting_ | https://seaborn.pydata.org/api.html 
[Selenium](https://github.com/SeleniumHQ/selenium)| _web scraping_ | https://selenium-python.readthedocs.io/api.html 
[Requests](https://github.com/psf/requests)| _web scraping_ | https://docs.python-requests.org/en/master/ 
BeautifulSoup| _web scraping_ | https://www.crummy.com/software/BeautifulSoup/bs4/doc/ 
[Scrapy](https://github.com/scrapy/scrapy)| _web scraping_ | https://docs.scrapy.org/en/latest/ 
shutil| _python module_ | 
%timeit| _built in python, (code optimizations)_ |
[Line profiler](https://github.com/pyutils/line_profiler)| _code optimizations_ |  
[Memory profiler](https://github.com/pythonprofilers/memory_profiler)| _code optimizations_ | 
[Flake8](https://github.com/PyCQA/flake8)| code style check | https://flake8.pycqa.org/en/latest/ 
[Singer](https://github.com/singer-io/singer-python)| open source ETL | https://github.com/singer-io/getting-started 
[Airflow](https://github.com/apache/airflow)| workflow | https://airflow.apache.org/docs/apache-airflow/stable/index.html 
...
### AutoML
- [auto-sklearn](https://github.com/automl/auto-sklearn) Automated Machine Learning with scikit-learn https://automl.github.io/auto-sklearn/master/  
- [Neural Network Intelligence](https://github.com/microsoft/nni) - An open source AutoML toolkit for automate machine learning lifecycle, including feature engineering, neural architecture search, model compression and hyper-parameter tuning. https://nni.readthedocs.io/en/stable/ 
- [Archai](https://github.com/microsoft/archai) - Reproducible Rapid Research for Neural Architecture Search (NAS).
- [FLAML](https://github.com/microsoft/FLAML) - A fast and lightweight AutoML library. https://microsoft.github.io/FLAML/#
...
- [NeuronBlocks](https://github.com/microsoft/NeuronBlocks) - building your nlp dnn models like playing lego https://microsoft.github.io/NeuronBlocks/build/html/index.html https://github.com/microsoft/NeuronBlocks/blob/master/Tutorial.md
...
### Distributed
- [DeepSpeed](https://github.com/microsoft/DeepSpeed) - DeepSpeed is a deep learning optimization library that makes distributed training easy, efficient, and effective. https://deepspeed.readthedocs.io/en/latest/ https://github.com/microsoft/DeepSpeedExamples
...
### Optimization
- [ONNXRuntime](https://github.com/microsoft/onnxruntime) - cross-platfom, high performance ML inference and training accelerator. https://www.onnxruntime.ai/docs/ 
